...
#   o2-raw-file-reader-workflow | o2-itsmft-stf-decoder-workflow | o2-mft-reco-workflow
...
if [ $# -ne ${NUMBER_OF_ARGS} ]; then
    ...
    echo "./run_decoding_and_tracking_workflow_noDigits.sh 0.001 1 /home/mft/data/ 256 data-2021_03_12__16_24_08__-20570-2 .raw"
    exit 1
fi
